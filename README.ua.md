...
*   📊 **Інтерактивна розшифровка балів**: Натисніть на картку будь-якого учасника, щоб миттєво побачити повну структуру його рейтингу (кількість повідомлень, відповідей та реакцій за трьома категоріями: Гуру, Флудер та Скептик).
*   🌐 **Локалізація UA | EN**: Зручний перемикач мов у верхньому правому кутку з автозбереженням вибору користувача.
*   🐳 **Docker-first Архітектура**: Легкий запуск та масштабування кількох ботів в ізольованих контейнерах за допомогою одного файлу конфігурації.
